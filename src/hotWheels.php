...
<nav class="navbar navbar-expand-md navbar-light ">
    ...
    <div class="colors">
      <img class="img-fluid imgs" src="../public/hot_wheels_banner.png" alt="Legos">
  </div>
...
//Feteches the data, where the brand in the database is 'hotwheels'

$result = mysqli_query($con,"SELECT * FROM `toys` WHERE `toy_brand` = 'hotwheels' ");
