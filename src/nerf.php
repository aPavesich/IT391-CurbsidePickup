...
<nav class="navbar navbar-expand-md navbar-light ">
    ...
    <div class="colors">
      <img class="img-fluid imgs" src="../public/nerf_banner.png" alt="Legos">
  </div>
...
//Feteches the data, where the brand in the database is 'Nerf'
$result = mysqli_query($con,"SELECT * FROM `toys` WHERE `toy_brand` = 'Nerf' ");
